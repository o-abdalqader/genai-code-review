...
class OpenAIClient:
    ...
    def __init__(self, model, temperature, max_tokens, azure_endpoint=None):
        """
        Initialize the OpenAIClient with API key, model, temperature, max tokens, and optional Azure endpoint.
        ...
        Args:
            ...
            azure_endpoint (str, optional): The Azure OpenAI endpoint.
        """
        try:
            self.client = OpenAI()
            self.model = model
            ...
            logging.info(
                ...
                "Model: %s, temperature: %s, max tokens: %s, Azure endpoint: %s",
                self.model,
                self.temperature,
                self.max_tokens,
                self.azure_endpoint
